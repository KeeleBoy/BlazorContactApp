...
{
    public class BlazorContactAppContext : DbContext
    {
        public BlazorContactAppContext(DbContextOptions<BlazorContactAppContext> options)
            : base(options)
        {
        }

        public DbSet<BlazorContactApp.Data.Contact> Contact { get; set; }
